...
import 'package:smn_admin/data/setting/model/language.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          tooltip: _trans.back,
          icon: Icon(Platform.isAndroid ? Icons.arrow_back : Icons.arrow_back_ios, color: Theme.of(context).hintColor),
        ...
        actions: <Widget>[
           NotificationButtonWidget(iconColor: Theme.of(context).hintColor, labelColor: Theme.of(context).accentColor),
        ],
      ),
