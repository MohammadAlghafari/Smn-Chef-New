...
class CreateRestaurantSecondScreen extends StatefulWidget {
  File image;
  String nameAr;
  String nameEn;
  ...
  @override
  _CreateRestaurantSecondScreenState createState() =>
      _CreateRestaurantSecondScreenState();
}

class _CreateRestaurantSecondScreenState
    extends State<CreateRestaurantSecondScreen> {
                      ...
                      child: TextFormField(
                        ...
                        validator: (text) {
                          ...
                          if (lat == null || lng == null) {
                            return _trans.please_type_address;
                          }
                          return null;
                        },
                        onTap: () {
