...
class User {
  ...
  factory User.fromJSON(Map<String, dynamic> jsonMap) {
    return User(
        ...
        phone: jsonMap['phone'] ?? "",
        verifiedPhone: jsonMap['custom_fields'] == null ||jsonMap['custom_fields'].length==0 ||
                jsonMap['custom_fields']['verifiedPhone'] == null
            ? false
            : jsonMap['custom_fields']['verifiedPhone']['view'] == '1',
        // address: jsonMap['custom_fields'] == null||jsonMap['custom_fields'].length==0||jsonMap['custom_fields']['address']
        //     ? " "
        //     : jsonMap['custom_fields']['address']['view']??' ',
        address: jsonMap['address'] ??' ',
        bio: jsonMap['custom_fields'] == null||jsonMap['custom_fields'].length==0
            ? ""
